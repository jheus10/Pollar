...
(function (global, factory) {
  ...
  class WordElement extends chart_js.Element {
    static computeRotation(o, rnd) {
      ...
      const base =
        Math.min(o.rotationSteps, Math.floor(rnd() * o.rotationSteps)) /
        (o.rotationSteps - 1);
    ...
    draw(ctx) {
      ...
      roundRect(
        ctx,
        props.x - width / 2 - size_increment,
        props.y - options.size,
        width + size_increment + 20,
        options.size + size_increment,
        10,
        options.color,
        true
      );
  ...
  function rnd(seed = Date.now()) {
    let s =
      typeof seed === "number"
        ? seed
        : Array.from(seed).reduce((acc, v) => acc + v.charCodeAt(0), 0);
    return () => {
  ...
  class WordCloudController extends chart_js.DatasetController {
    constructor() {
      ...
      this.wordLayout = d3Cloud()
        ...
        .fontWeight((d) => {
          var _a;
          return (_a = d.options.weight) !== null && _a !== void 0 ? _a : 1;
        });
    ...
    updateElements(elems, start, count, mode) {
      ...
      for (let i = start; i < start + count; i += 1) {
        ...
        const properties = {
          ...
          x:
            (_b =
              (_a = this._cachedMeta.xScale) === null || _a === void 0
                ? void 0
                : _a.getPixelForDecimal(0.5)) !== null && _b !== void 0
              ? _b
              : 0,
          y:
            (_d =
              (_c = this._cachedMeta.yScale) === null || _c === void 0
                ? void 0
                : _c.getPixelForDecimal(0.5)) !== null && _d !== void 0
              ? _d
              : 0,
          width: 10,
          height: 10,
      ...
      const run = (factor = 1, tries = 3) => {
        this.wordLayout
          ...
          .on("end", (tags, bounds) => {
            ...
            indices.forEach((i) =>
              this.updateElement(elems[i], i, { scale: 0 }, mode)
            );
          })
          .start();
      };
  ...
  class WordCloudChart extends chart_js.Chart {
    constructor(item, config) {
      super(
        item,
        patchController("wordCloud", config, WordCloudController, WordElement)
      );
    }
  }
