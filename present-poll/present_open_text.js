...
if (updated_data.length == 0) {
  user_id.innerHTML = "No responses yet.";
  setInterval(() => {
    location.reload();
  }, 5000);
}
...
for (var i = 0; i <= res.user_id.length - 1; i++) {
  user_id.innerHTML +=
    '<div class="msg left-msg"><div class="msg-img"></div><div class="msg-bubble"><div class="msg-info"><div class="msg-info-name">' +
    res.user_id[i] +
    '</div><div class="msg-info-time"></div></div><div class="msg-text">' +
    updated_data[i] +
    "</div></div></div>";
